        ...
        <div className="w-full px-2">
            <div className="relative w-full mb-3">
                <button
                    ...
                    type={type}
                    min={0}
                    className={`${color == "green" ? "bg-green-400 text-white" : "bg-gray-200"} ${color == "red" ? "bg-red-400 text-white" : "bg-gray-200"}  border-0 px-3 text-left py-3 placeholder-blueGray-300 dark:placeholder-slate-500 text-slate-700 dark:text-slate-200 ${bgWhite ? "bg-white" : "bg-gray-200"
