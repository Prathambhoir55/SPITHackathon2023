...
const Inventory = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    const res = await fetch(
      "https://95d5-2402-3a80-6ff-3e4d-c83b-8d43-d444-56e7.in.ngrok.io/doubts/doubts/",
      {
        method: "POST",
        headers: {
        ...
        {chat.map((i) => {
          return i.user == "bot" ? (
            <div className="p-6 bg-gray-300/[0.4] rounded-md shadow-md ml-2">
              <div class="flex items-center text-sm justify-center h-10 w-10 rounded-full bg-purple-400 flex-shrink-0">
            ...
            <div
              ...
              <div class="flex items-center justify-center text-sm h-10 w-10 text-white rounded-full bg-slate-900 flex-shrink-0">
...
const Chatmsg = ({ message }) => {
  <div class="col-start-1 col-end-8 p-3 rounded-lg">
    <div class="flex flex-row items-center">
      <div class="flex items-center justify-center h-10 w-10 rounded-full bg-green-500 flex-shrink-0">
        <AiFillRobot className="text-lg"></AiFillRobot>
      </div>
