	...
	return (
		<form className="max-w-sm bg-white px-8 py-7 rounded-2xl shadow-xl w-full">
			...
			<div className="grid grid-cols-2 gap-6">
				...
				<div
					className="text-center px-3 py-3 line-through placeholder-blueGray-300 text-slate-700 placeholder:text-slate-400 bg-gray-50  border borderColor rounded-xl text-base  focus:outline-none w-full ease-linear transition-all duration-150"
				>
					{captcha}
				</div>
				<input
